import { EGSTD, EGSTDUnitInfo } from "../zatca/egstd";
import { ZATCAStandardInvoiceLineItem } from "../zatca/templates/standard_tax_invoice_template";
import { ZATCAStandardTaxInvoice } from "../zatca/ZATCAStandardTaxInvoice";
import { generatePhaseOneQR } from "../zatca/qr";

// Sample line item
const line_item: ZATCAStandardInvoiceLineItem = {
    id: "1",
    name: "TEST NAME",
    quantity: 5,
...
const egsunit: EGSTDUnitInfo = {
    ...
    buyerStreet: "King Fahahd st",
    buyerBuilding: "0000",
    buyerPlot_identification: "0000",
...
const main = async () => {
    try {
        ...
        console.log( await egs.clearanceInvoice(signed_invoice_string, invoice_hash) );
