...
import defaultSimplifiedTaxInvoice, {
    ZATCAStandardInvoiceLineItem,
    ZATCAStandardInvoiceProps,
    ZATCAStandardInvoiceTypes,
    ZATCAStandardPaymentMethods
} from "./templates/standard_tax_invoice_template";
...
export class ZATCASimplifiedTaxInvoice {
     ...
     * @param props ZATCAStandardInvoiceProps props to create a new unsigned invoice.
     */
    ...
    private constructLineItemTotals = (line_item: ZATCAStandardInvoiceLineItem) => {
    ...
    private constructLineItem = (line_item: ZATCAStandardInvoiceLineItem) => {
    ...
    private constructTaxTotal = (line_items: ZATCAStandardInvoiceLineItem[]) => {
    ...
    private parseLineItems(line_items: ZATCAStandardInvoiceLineItem[], props: ZATCAStandardInvoiceProps) {
